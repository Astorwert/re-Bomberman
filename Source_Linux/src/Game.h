...
private:
	...
	Uint8 *wavDeath;
	Uint8 *wavExplosion;
	SDL_AudioDeviceID Channel1 = SDL_OpenAudioDevice(NULL, 0, &wavSpec, NULL, 0);
	SDL_AudioDeviceID Channel2 = SDL_OpenAudioDevice(NULL, 0, &wavSpec1, NULL, 0);
	SDL_AudioDeviceID Channel3 = SDL_OpenAudioDevice(NULL, 0, &wavSpec2, NULL, 0);
